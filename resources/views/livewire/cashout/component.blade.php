    ...
    <div class="row content-header ">
        <div class="col-xs-12 col-md-3">
            <div class="input-group">
                ...
                <input type="date" wire:model.lazy="fromDate" class="form-control pull-right active">
             ...
             <div class="input-group">
                ...
                <input type="date" wire:model.lazy="toDate" class="form-control pull-right active">
                @error('toDate') <span class="text-danger">{{ $message }}</span>@enderror
            </div><!-- /input-group date to -->
        </div>
        ...
        <!--   / <select class="form-control select2 select2-hidden-accessible" data-placeholder="Selecciona el cliente" name="customer_id" id="customer_id" tabindex="-1" aria-hidden="true">
          ...
          @if($userid > 0 && $fromDate != null && $toDate != null)
           ...
           <div class="form-group">
                <button wire:click.prevent="Consultar()" type="button" class="btn btn-flat btn-sm">Consultar</button>
                @if($total > 0)
                <button wire:click.prevent="Print()" type="button" class="btn btn-flat btn-sm"><span><i class="fa fa-print class="text-light></i> </span>Imprimir</button>
                @endif
           </div>
            </div>
           @endif
