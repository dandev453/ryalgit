                    ...
                    <form  class="form-horizontal" role="form">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active text-info"><a href="#details" data-toggle="tab" aria-expanded="false">  Detalles de la venta</a></li>
                            </ul>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr class="text-center">
                                                        <td colspan="4"><h6 class="text-info float-right ">total: <span class="bg-success">${{number_format($mytotal ), 2}}</h6></span></td>
                                                    @endif
                                                    </tr>
                                                </tr>
                                            </tbody>
