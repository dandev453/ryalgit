                                    ...
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#details" data-toggle="tab"
                                                    aria-expanded="false">DETALLES DEL PERMISO DEL USUARIO</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" wire:model.lazy="permissionName"
                                                            class="form-control" placeholder="ej: category_index">
